/**
 * Robust Blogger Scraper (urdunovelians.com)
...
function robustBloggerScraper() {
  ...
  while (true) {
    ...
    // بلاگر فیڈ یو آر ایل (urdunovelians.com)
    const feedUrl = `https://www.urdunovelians.com/feeds/posts/default?alt=json&published-min=${publishedMin}&published-max=${publishedMax}&max-results=50&start-index=${startIndex}`;
