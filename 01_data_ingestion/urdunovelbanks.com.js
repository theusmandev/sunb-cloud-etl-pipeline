...
function robustBloggerScraper() {
  ...
  while (true) {
    ...
    // بلاگر فیڈ یو آر ایل
    const feedUrl = `https://urdunovelbanks.com/feeds/posts/default?alt=json&published-min=${publishedMin}&published-max=${publishedMax}&max-results=50&start-index=${startIndex}`;
